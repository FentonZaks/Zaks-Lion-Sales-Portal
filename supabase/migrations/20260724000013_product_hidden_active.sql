...
-- Add is_hidden and is_active columns
...
BEGIN
    ...
    LOOP
        INSERT INTO public.products (
            ...
            inventory_by_location, primary_category, secondary_category, is_active, is_hidden, updated_at
        )
        VALUES (
            ...
            true, -- New products are hidden by default
            NOW()
        )
        ON CONFLICT (sku) DO UPDATE SET
            ...
            -- Do NOT overwrite is_hidden, allowed_provinces, or allowed_countries!
            updated_at = NOW();
    END LOOP;
END;
$$;
