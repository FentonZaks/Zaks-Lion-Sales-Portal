-- 20260806000000_last_month_revenue.sql

-- 1. Add revenue columns to customers table
ALTER TABLE public.customers ADD COLUMN IF NOT EXISTS last_month_revenue NUMERIC;

-- 2. Drop the old RPC to redefine it with new fields
DROP FUNCTION IF EXISTS sync_customer_data(JSONB);

-- 3. Recreate the RPC function to handle all fields including last_month_revenue
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO public.customers (
            ...
            mtd_revenue, ytd_revenue, last_month_revenue, updated_at
        )
        VALUES (
            v_net_suite_id,
