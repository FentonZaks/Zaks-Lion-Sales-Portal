...
-- Add new columns for kits and case quantities
...
BEGIN
    ...
    LOOP
        ...
        ON CONFLICT (sku) DO UPDATE SET
            ...
            -- Do NOT overwrite is_hidden, is_kit_only, allowed_provinces, or allowed_countries!
            updated_at = NOW();
    END LOOP;
END;
$$;
