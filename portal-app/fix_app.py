...
base_dir = r'C:\Users\Bryan\Zaks Foods LLC\ZAKS SALES PORTAL\portal-app\src'

app_tsx = """import { BrowserRouter as Router, Routes, Route, Link } from 'react-router-dom';
...
with open(os.path.join(base_dir, 'App.tsx'), 'w', encoding='utf-8') as f:
    f.write(app_tsx)
